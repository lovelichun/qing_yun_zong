<template>
  <div class="magic-tool-container">
    <el-card>
      <template #header>
        <div class="card-header">
          <span>法器管理</span>
          <el-button type="primary" @click="handleAdd">新增法器</el-button>
        </div>
      </template>
...
const handleDelete = async (id) => {
  try {
    await ElMessageBox.confirm('确定要删除该法器吗?', '提示', {
      type: 'warning'
    })
