    ...
    <el-card>
      <template #header>
        <div class="card-header">
          <span>宝物管理</span>
          <el-button v-hasPermi="'treasure:add'" type="primary" @click="handleAdd">新增宝物</el-button>
        </div>
      </template>
      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column label="操作" width="180" fixed="right">
          <template #default="{ row }">
            <el-button v-hasPermi="'treasure:update'" link type="primary" @click="handleEdit(row)">编辑</el-button>
            <el-button v-hasPermi="'treasure:delete'" link type="danger" @click="handleDelete(row.id)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
